globalThis.__VINEXT_LAZY_CHUNKS__ = ["assets/page-BWy2zslf.js","assets/layout-segment-context-C_UbHzfF.js"];
...
function getDraftSecret() {
	return "4d8d4857-cda4-46d5-8323-2b5e0f216a37";
}
/**
...
var NextURL = class NextURL {
	...
	*/
	get buildId() {
		return "b634e2a3-e92f-4171-99c8-e62d0df18a15";
	}
};
...
*/
function appIsrCacheKey(pathname, suffix, buildId = "b634e2a3-e92f-4171-99c8-e62d0df18a15") {
...
function createAppPageArtifactCompatibility(element, routePattern) {
	...
	return createArtifactCompatibilityEnvelope({
		...
		deploymentVersion: "b634e2a3-e92f-4171-99c8-e62d0df18a15",
		rootBoundaryId
	});
}
/**
